...
public class EnemyContext
{
    ...
    public bool UseWaypoints() => _enemyMachine.HasState(EnemyMachine.EnemyState.Waypoint);
    public bool UseChase() => _enemyMachine.HasState(EnemyMachine.EnemyState.Chase);
    public bool UseReposition() => _enemyMachine.HasState(EnemyMachine.EnemyState.Reposition);
    public bool UseAttack() => _enemyMachine.HasState(EnemyMachine.EnemyState.Attack);
    public bool UseMelee() => _enemyMachine.HasState(EnemyMachine.EnemyState.Melee);
    public bool UseCover() => _enemyMachine.HasState(EnemyMachine.EnemyState.Cover);
